            ...
            <div class="InsDetails3" style="border-top: none;font-size: 15px;">
                ...
                <?php foreach($kejie['pp'] as $key=>$val){?>
                    ...
                    <?php foreach($val['pp'] as $k=>$v){?>
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="<?php echo e(URL('bfang')); ?>?fid=<?=$v['id']?>&cur_id=<?=$curone['cur_id']?>" ids="<?=$v['id']?>" class="bfang"><?=$v['file_name']?></a>
                    <br/>
                    <?php }?>
                <?php }?>
            </div>
...
//        alert(bfang)
    ...
    function _toCharge(id){
        $.post("<?php echo e(url('shopcart')); ?>",{'_token':'<?php echo e(csrf_token()); ?>','id':id},function(data){
//              alert(data)
