    ...
    $.get("<?php echo e(URL('search')); ?>",{"search":search},function(msg){
      ...
      console.log(msg);
         for(var i=0;i<msg.length;i++){
              str+="<div class='NewsList'><ul class='clearfix classul'><li><div class='bord'><div class='lt'><a href='<?php echo e(URL('cont')); ?>?cur_id="+msg[i]['cur_id']+"'><img src=http://admin.duzejun.cn/"+msg[i]['cur_img']+" height='50px;' width='50px;' /></a></div><div class='rt'><a href='#' ><div class='rt1'><h3>"+msg[i]['cur_name']+"</h3><p>"+msg[i]['cur_describe']+"</p></div></a><div class='rt2'><p class='orange'><i class='f15 mr5'>&yen;</i><i class='f20'>"+msg[i]['cur_price']+"</i></p></div></div></div></li></ul></div>";
       }
        $("#div1").html(str);
    },'json')
   })
