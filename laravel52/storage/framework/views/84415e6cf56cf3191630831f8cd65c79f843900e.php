...
<ion-view title="Home" hide-nav-bar="true">
    <ion-scroll  direction="y" scrollbar-y="false" style="width: 100%; height: 100%">
        ...
        <div class="NewsList">
            <a href="<?php echo e(URL('mogbo')); ?>">查看未直播视频 ☚</a>
             ...
             <?php foreach($data as $key=>$val){?>
                <?php if($val['begintime']<=time()&&$val['endtime']>=time()){?>
                 <li>
                     <div class="bord">
                         <div class="lt">
                             <a href="<?php echo e(URL('begbo')); ?>?id=<?=$val['id']?>" title=""><img src="http://study.dazejun.cn/<?=$val['photo']?>" height="50" width='50' alt=""/></a>
                         </div>
                         <div class="rt1">
                             <a href="<?php echo e(URL('begbo')); ?>?id=<?=$val['id']?>" title="">
                                 <div class="rt1">
                                     <h3><?=$val['title']?></h3>
