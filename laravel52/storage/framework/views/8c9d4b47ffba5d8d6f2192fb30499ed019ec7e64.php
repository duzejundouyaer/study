        ...
        <ul class="clearfix classul">    
                    ...
                    <div class="bord">
                        ...
                        <div class="rt">
                            <a href="#" title="">
                                <div class="rt1">
                                    <h3><?php echo e($val['order_name']); ?></h3>
                                    <a href="javascript:void(0)027-86730762"><p><?php echo e($val['add_time']); ?></p></a>
                               </div>
                            </a>
                            <div class="rt2">
                                <p class="orange"><i class="f15 mr5">&yen;</i><i class="f20"><?php echo e($val['price']); ?></i></p>
